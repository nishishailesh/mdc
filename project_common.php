...
function echo_class_button($link,$classs)
{
	...
	echo 	'<div class="d-inline-block ">
			<div class=print_hide>
				<button type=button class="btn btn-info d-inline-block border-danger m-0 p-0" 
					onclick="set_print_class(\''.htmlspecialchars($jarray).'\');set_header(\''.$ar['header'].'\')">MedicineDC
				</button>
			</div>
		</div>';
